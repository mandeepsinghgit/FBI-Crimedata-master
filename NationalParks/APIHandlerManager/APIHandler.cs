...
namespace NationalParks.APIHandlerManager
{
  public class APIHandler
  {
    ...
    static string BASE_URL = "https://crime-data-explorer.fr.cloud.gov/api";
    static string API_KEY = "82jf0npYtfER8K9pGrumh5PE8YJCWBc5bN9ztDcR"; //Add your API key here inside ""
